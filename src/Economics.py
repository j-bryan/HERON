...
class CashFlow:
  ...
  def __init__(self, component):
    ...
    self._parametric_params = []  # parameters defined by Parametric ValuedParams; may be sampled after dispatch solution
  ...
  def _set_valued_param(self, name, spec):
    ...
    if vp.is_parametric():  # parameters to sample after dispatch optimization
  ...
  def get_parametric_params(self):
    """
      Fetches parameters defined by Parametric ValuedParams, as stored in self._parametric_params
      @ In, None
      @ Out, parametric_params, list, list of parameters defined by Parametric ValuedParams
    """
